...
struct Dota2SenateTest {
    ...
    class Solution {
        func predictPartyVictory(_ senate: String) -> String {
            ...
            for (index, character) in senate.enumerated() {
                if character == "R" {
    ...
    @Test func example1() {
        #expect(Solution().predictPartyVictory("RD") == "Radiant")
    }

    @Test func example2() {
        #expect(Solution().predictPartyVictory("RDD") == "Dire")
    }
